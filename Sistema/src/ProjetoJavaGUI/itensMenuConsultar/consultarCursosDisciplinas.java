 ...
 * @author CDIAS
 */
public class consultarCursosDisciplinas extends javax.swing.JFrame {

    public consultarCursosDisciplinas() {
        initComponents();
        setTitle("Sistema de Controle Acadêmico - Consultar: Cursos/Disciplinas");
        setLocation(500,150);
	    setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTAR CURSOS/DISCIPLINAS");
    ...
    private void botaoConsultaActionPerformed(java.awt.event.ActionEvent evt) {    
        ...
        try{    
            ...
            String consultaSQL = "SELECT nome_curso,nome_disciplina FROM cursos INNER JOIN disciplina ON cursos.id_curso = disciplina.id_curso_disciplina_fk";
