 ...
 * @author CDIAS
 */
public class consultarCursosProfessores extends javax.swing.JFrame {

    /**
     * Creates new form consultarCurso
     */
    public consultarCursosProfessores() {
        initComponents();
        setTitle("Sistema de Controle Acadêmico - Consultar: Cursos/Professores");
        setLocation(500,150);
	    setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTAR CURSOS/PROFESSORES");
    ...
    private void botaoConsultaActionPerformed(java.awt.event.ActionEvent evt) {    
        ...
        try{    
            ...
            String consultaSQL = "SELECT nome_curso,nome_prof FROM cursos INNER JOIN professor ON cursos.id_curso = professor.id_curso_prof_fk";
