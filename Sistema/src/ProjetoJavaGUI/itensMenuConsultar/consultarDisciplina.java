...
public class consultarDisciplina extends javax.swing.JFrame {
    ...
    public consultarDisciplina() {
        initComponents();
        setTitle("Sistema de Controle Acadêmico - Consultar: Disciplinas");
        setLocation(500,150);
	    setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID da Disciplina", "Nome do Disciplina", "Carga Horária", "Aulas", "ID do Curso"
            }
        ) {
        ...
        jLabel1.setText("CONSULTAR DISCIPLINAS");
    ...
    private void botaoConsultaActionPerformed(java.awt.event.ActionEvent evt) {    
        ...
        try{    
            ...
            String consultaSQL = "SELECT * FROM disciplina";
